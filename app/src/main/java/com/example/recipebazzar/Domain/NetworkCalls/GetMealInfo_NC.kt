package com.example.recipebazzar.Domain.NetworkCalls
    ...
    (private val repository: Repository)
{
    ...
    operator fun invoke(mealId: String): Flow<NetworkEvents<List<Meal_Info>>> = flow {
        ...
        try {
            ...
            emit(NetworkEvents.Error<List<Meal_Info>>(e.localizedMessage ?: "MealInfo network call, unexpected error occured "))
