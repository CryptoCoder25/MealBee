...
fun MealInfoPage(
    ...
    val state =   viewModel.state.value
         ...
         if (state.mealinfo.isNotEmpty()) {
             mealdata = state.mealinfo[0]
         }
                    ...
                    modifier = Modifier
                        ...
                        content = {
                            ...
                            items(MealInfoItemsFormatter.getMeasurements(mealdata).size) { index ->
                                ...
                                val ingriedient = MealInfoItemsFormatter.getIngredients(mealdata)[index]
                                val measurement = MealInfoItemsFormatter.getMeasurements(mealdata)[index]

                                if (measurement.toString().isEmpty() ||
